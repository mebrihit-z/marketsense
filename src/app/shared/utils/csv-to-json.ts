/**
 * TypeScript utility to convert CSV files to JSON format
 * This is a Node.js script that can be run with ts-node or compiled to JavaScript
 * 
 * Usage:
 *   ts-node csv-to-json.ts [csv_file] [options]
 * 
 * Example:
 *   ts-node csv-to-json.ts marketsense_input_data.csv -o marketsense_chart_data.json
 */
