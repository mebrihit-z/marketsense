...
export class DashboardComponent implements OnInit {
  marketFlowCards: MarketFlowCard[] = [
    ...
    },
    {
      ...
      metricLabel: 'Net Flow',
      aiConfidence: 'high',
      description: 'Capital outflows driven by weaker local currencies and cautious investor sentiment amid rising geopolitical tensions.',
      chartColor: 'red',
      borderColor: '#fb2c36'
    },
    {
      id: '6',
      title: 'US Large Cap Resillience',
      value: '$98.4B',
      valueColor: 'green',
      percentageChange: '+4.6%',
      percentageColor: 'green',
      ...
      aiConfidence: 'medium',
      description: 'Large U.S. equity companies show renewed strength as easing inflation and stable earnings expectations lift investor confidence.',
      chartColor: 'green',
      borderColor: '#00bc7d'
    },
  ];
