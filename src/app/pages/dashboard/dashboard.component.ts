...
import { SankeyDiagramComponent } from '../../shared/components/charts/sankey-diagram/sankey-diagram.component';

@Component({
  selector: 'app-dashboard',
  standalone: true,
  imports: [CommonModule, FiltersBarComponent, FeaturedMarketFlowsCarouselComponent, AssetFlowsComponent, AssetAllocationComponent, SankeyDiagramComponent],
